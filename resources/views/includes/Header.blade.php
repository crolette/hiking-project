<header class=" w-full p-4 bg-blue-500">
 <nav class="flex justify-evenly text-white font-semibold items-center ">
    ...
    <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"><a href="/register" class="hover:underline hover:text-blue-200">Register</a></button>
